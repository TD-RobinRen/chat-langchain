...
def _diff_chain(input) -> Runnable:
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            ...
            few_shot_prompt,
            ("human", "diff_json: {diff_json}, question: {question}"),
        ]
    )
